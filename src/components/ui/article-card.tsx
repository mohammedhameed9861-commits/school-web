...
export interface ArticleCardProps {
  ...
  excerpt: string;
  delayIn?: number;
  /** Real photo for this article. Falls back to the gradient placeholder when absent. */
  image?: string;
}

export const ArticleCard = ({ categoryLabel, title, excerpt, delayIn = 0, image }: ArticleCardProps) => {
  return (
    <InteractiveCard
      tag="article"
      delayIn={delayIn}
